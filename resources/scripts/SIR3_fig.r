# program spuRs/resources/scripts/SIR3_fig.r
...
library(lattice)
postscript('../graphics/SIR3.ps', width=6, height=6)
print(wireframe(S_T ~ a*b, data = g, scales = list(arrows = FALSE), aspect = c(.5, 1),
  drape = TRUE, xlab = "a", ylab = "b", zlab = "E S[T]"))
dev.off()
